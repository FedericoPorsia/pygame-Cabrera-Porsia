...
def dibujar1(screen, productos_en_pantalla, producto_principal, producto_candidato, puntos, segundos, nivel):

    #mitad de tamaño
    defaultFont = pygame.font.Font("assets/font.ttf", 10)
    defaultFontGrande = pygame.font.Font("assets/font.ttf", 15)
